import unittest
from src.heaps.combinesortell import combine_sorted_linked_lists, combine_sorted_linked_lists_python_heap
...
class TestCombineSortedLinkedList(unittest.TestCase):
    ...
    def test_combine_sorted_linked_list(self):
        ...
        self.assertEqual(result, list_node_from_array([1, 1, 1, 1, 3, 3, 4, 4, 6, 6, 6, 6, 7, 7]))    
    ...
    def test_combine_sorted_linked_list(self):
        ...
        result = combine_sorted_linked_lists_python_heap([l1, l2, l3, l4])
        self.assertEqual(result, list_node_from_array([1, 1, 1, 1, 3, 3, 4, 4, 6, 6, 6, 6, 7, 7]))    